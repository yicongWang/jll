...
import com.zifisense.jll.common.constants.Constants;
...
import com.zifisense.jll.dao.CaptchaMapperExt;
...
public class CaptchaServiceImpl implements CaptchaService {
    ...
    public String add(CaptchaDTO captchaDTO) {
        ...
        if(Constants.CAPTCHA_TYPE_RETRIEVE_PASSWORD.equals(captchaDTO.getType())){
            ...
            List<Account> list = accountService.findAccounts(conditionSysUser);
