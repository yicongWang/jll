package com.zifisense.jll.service.common.log;
...
//    @Pointcut("execution(public * com.zifisense.jll.controller..*.*(..))")
    @Pointcut("@annotation(com.zifisense.jll.service.common.log.OperationnLogAnnotation)")
    public void webLog(){}
