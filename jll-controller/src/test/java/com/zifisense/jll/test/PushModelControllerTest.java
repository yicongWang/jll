 ...
 * @author wyc
 */
public class PushModelControllerTest {
		private static  String url = "http://localhost:8091/push";
	    ...
	    @Test
	    public void findPushModel(){
	         try {
	         	 Map<String,Object>  map = new HashMap<>();  
	        	 map.put("access_token",access_token);
	        	 String result = RestTester.exchange(url+"/findPushModel",map,HttpMethod.GET, String.class);
	        	 System.out.println(result);
	         } catch (Exception e) {
	            e.printStackTrace();
	        }
	    ...
	    @Test
	    public void setPushModel(){
	         try {
	         	 Map<String,Object>  map = new HashMap<>();  
	        	 map.put("access_token",access_token);
	         	 map.put("id",1);
	         	 map.put("state",1);
	        	 String result = RestTester.exchange(url+"/setPushModel",map,HttpMethod.POST, String.class);
	        	 System.out.println(result);
	         } catch (Exception e) {
	            e.printStackTrace();
	        }
